...
LISTADE.insertFirst('a');
LISTADE.insertLast('b');
LISTADE.insertLast('c');
LISTADE.insertLast('d');
console.log(LISTADE.getSize()); //retorna 4
LISTADE.removeFrom(2);
console.log(LISTADE.print());
console.log(LISTADE.getSize()); // retorna 3