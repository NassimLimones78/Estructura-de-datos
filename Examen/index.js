...
function App() {
  ...
  this.CheckData = () => {
    return (!(matriculaInput.value.trimStart() && nombreInput.value.trimStart() && materiaInput.value.trimStart() && calificacionInput.value.trimStart())) || (this.data.filter(obj => obj.matricula === matriculaInput.value && obj.matricula !== this.currentID).length != 0);
  };
  ...
  this.Insert = (e) => {
    ...
    if (this.currentID != null) {
      this.data[this.data.findIndex(obj => obj.matricula === this.currentID)] = obj;
